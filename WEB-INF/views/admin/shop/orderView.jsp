...
*/
 ...
 .orderInfo span { font-size:16px; font-weight:bold; display:inline-block; width:90px; }
 ...
 .gdsInfo span { font-size:16px; font-weight:bold; display:inline-block; width:100px; margin-right:10px; }
