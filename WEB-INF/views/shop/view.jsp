...
<head>
	...
	<style>
		...
		div.goods div.goodsInfo p.cartStock input { font-size:15px; width:50px; padding:5px; margin:0; border:1px solid #eee; }
		div.goods div.goodsInfo p.cartStock button { font-size:18px; border:none; background:none; } 
		div.goods div.goodsInfo p.addToCart { text-align:right; }
		div.goods div.goodsInfo p.addToCart button { font-size:15px; padding:5px 10px; border:1px solid #eee; background:#eee;}
		div.goods div.gdsDes { font-size:15px; clear:both; padding-top:30px; }
	</style>
 ...
 section.replyList div.userInfo .userName { font-size:22px; font-weight:bold; }
 section.replyList div.userInfo .date { color:#999; display:inline-block; margin-left:10px; }
 section.replyList div.replyContent { padding:10px; margin:20px 0; }
 section.replyList div.replyFooter { margin-bottom:10px; }
 
 section.replyList div.replyFooter button { font-size:13px; border: 1px solid #999; background:none; margin-right:10px; }
</style>
...
<style>
 ...
 div.modalContent button { font-size:15px; padding:5px 10px; margin:10px 0; background:#fff; border:1px solid #ccc; }
