 ...
 */
 ...
 section#content div.gdsInfo { font-size:16px; line-height:2; }
 ...
 section#content div.gdsInfo .delete button { font-size:16px; padding:5px 10px; border:1px solid #eee; background:#eee;}
 
.allCheck { float:left; width:200px; }
.allCheck input { width:16px; height:16px; }
.allCheck label { margin-left:10px; }
.delBtn { float:right; width:300px; text-align:right; }
.delBtn button { font-size:16px; padding:5px 10px; border:1px solid #eee; background:#eee;}

.checkBox { float:left; width:30px; }
.checkBox input { width:16px; height:16px; }

.listResult { padding:20px; background:#eee; }
.listResult .sum { float:left; width:45%; font-size:16px; }

.listResult .orderOpne { float:right; width:45%; text-align:right; }
.listResult .orderOpne button { font-size:16px; padding:5px 10px; border:1px solid #999; background:#fff;}
...
.orderInfo .inputArea button { font-size:16px; border:2px solid #ccc; padding:5px 10px; background:#fff; margin-right:20px;}
 ...
 <form role="form" method="post" autocomplete="off">
  ...
  <div class="inputArea">
	...
	$("#check_module").click(function () {
		...
		amount: 1000, //가격
		buyer_email: 'gkrudgkrud@gmail.com',
		buyer_name: 'gkrud',
